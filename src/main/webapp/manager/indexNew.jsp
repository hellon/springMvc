        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li >
                        <a href="chart.jsp"><i class="fa fa-signal"></i> <span class="nav-label">数据统计</span></a>
                    </li>                     
                    <li>
                        <a href="user_manager.jsp"><i class="fa fa-user"></i> <span class="nav-label">用户管理</span></a>
                    </li>
                    <li >
                        <a href="device_manager.jsp"><i class="fa fa-video-camera"></i> <span class="nav-label">设备管理</span></a>
                    </li>
                    <li>
                        <a href="alarm_manager.jsp"><i class="fa fa-exclamation-triangle"></i> <span class="nav-label">报警管理</span></a>
                    </li>
                    <li >
                        <a href="userdevice.jsp"><i class="fa fa-lock"></i> <span class="nav-label">绑定管理</span></a>
                    </li>
					<li class="active">
                        ...
                        <ul id="authSub" class="nav nav-second-level">
                            ...
                            <li><a id="roleManage" href="#">角色管理</a> </li>
                            <li><a id="functionManage" href="#" onclick="clickLink('authority_managerSub.jsp','功能管理')">功能管理</a> </li>
                        </ul>
                    </li>
                </ul>
